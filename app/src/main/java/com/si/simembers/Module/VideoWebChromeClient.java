...
public class VideoWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener {
...
//                activityVideoView.requestLayout();
    ...
    public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
        ...
        tempView.setWebViewClient(webViewClient);

        WebSettings webSet = tempView.getSettings();
