...
public class NestedWebView extends WebView implements NestedScrollingChild, NestedScrollingParent {
    ...
    private void onLoad() {
        if (G.USER_LOGIN) {
            String nbrNo = Preferences.loadSharedPreferencesString(BaseApplication.getContext(), Preferences.ENC_MBR_NO);
            String token = new TokenManager(BaseApplication.getContext()).createToken(nbrNo);
